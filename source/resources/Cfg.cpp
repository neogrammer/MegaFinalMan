...
{
	textures.load((int)Textures::Background_Start, "assets/textures/backgrounds/game_start_bg.jpg");
	textures.load((int)Textures::PlayerAtlas, "assets/textures/player/playerAtlas.png");
