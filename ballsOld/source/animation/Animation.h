...
public:
	Animation(std::string id_ = "Default", std::string dir_ = "Uni", float frameDelay_ = { 0.13f }, unsigned numFrames_ = 1, sf::Vector2f frameSize_ = {50.f,50.f}, sf::Vector2f texStartPos_ = { 0.f,0.f });
	~Animation();
